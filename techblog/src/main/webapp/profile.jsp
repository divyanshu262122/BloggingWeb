...
<html>
    <head>
     ...
     <!--  -->   <style>
            .banner-background{
             ...
             body{
                background: url(images/tech-blog.jpg);
    ...
    <body>
        <!--navvar-->
       <nav class="navbar navbar-expand-lg navbar-dark text-black bg-info">
  <a class="navbar-brand" href="index.jsp"> <h2> <img src="images/bloggers.jpg" width="30" height="30" alt="loading error">  TECH-BLOGGER</h2> </a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="#"><span class="fa fa-bell-o"></span>Learn about us! <span class="sr-only">(current)</span></a>
      </li>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="container text-center">
                            <img src="Pics/default.png"class="img-fluid" style="border-radius:20px; max-height: 200px; max-width:250px; "><br>
                            ...
                            <form action="EditProfileServlet" enctype="multipart/form-data">
                                ...
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="file" class="form-control" name="profile" value="<%=u.getProfile()%>"></td>
                                    </tr>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="postform" action="AddPostServlet" method="Post" enctype="multipart/form-data">
                            ...
                            <div  class="form-group">
                                <textarea name="pcontent" placeholder="Enter post content.." class="form-control"></textarea>
                            </div>
                            <div  class="form-group">
